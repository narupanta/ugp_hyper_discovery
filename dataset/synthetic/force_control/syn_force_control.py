...
def parse_args():
    ...
    parser.add_argument('--n_steps', type=int, default=10, help="Number of load steps")
...
if __name__ == "__main__" :
    ...
    mesh_msh_path = os.path.join(mesh_dir, "block_mesh.msh")
    mesh_npz_path = os.path.join(mesh_dir, "block_mesh.npz")
    ...
    mesh_size_near = args.mesh_size / 4.0
