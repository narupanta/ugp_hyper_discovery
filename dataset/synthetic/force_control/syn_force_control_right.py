...
def plot_dataset_viz(data, material_model_name, disp_noise_level, load_noise_level, target_load, asym_factor, save_path) :
    ...
    plt.savefig(save_path + f"/{material_model_name}_{disp_noise_level}_{load_noise_level}_{target_load}_{asym_factor}_right_60deg.pdf", dpi=300, bbox_inches='tight')
